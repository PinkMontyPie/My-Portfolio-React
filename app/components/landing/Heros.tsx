...
const HeroPage = () => {
  ...
  return (
    <main className="font-line-bold text-black">
      <div className="grid grid-cols-1 md:grid-cols-3 flex-col h-screen md:px-16 custom-bg-image">
        ...
        <div className="flex flex-col justify-between items-center gap-24">
          ...
          <div className="flex flex-grow items-end w-[600px] h-auto object-cover object-center">
            <img src="/images/yes.png" alt="hero" className="" />
          </div>
